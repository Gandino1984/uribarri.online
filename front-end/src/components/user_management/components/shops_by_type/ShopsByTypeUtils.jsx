...
export const ShopsByTypeUtils = () => {
  ...
  const fetchShopsByType = async () => {
    if (!shopType) {
      console.log('-> ShopsByTypeUtils.jsx - fetchShopsByType() - No hay tipo de tienda seleccionado');
      setShops([]);
      return;
    }

    console.log('-> ShopsByTypeUtils.jsx - fetchShopsByType() - Buscando comercios del tipo = ', shopType);
    setLoading(true);
    ...
    try {
      ...
      console.log('-> ShopsByTypeUtils.jsx - fetchShopsByType() - shops:', validShops);
      setShops(validShops);
      
    } catch (err) {
      console.error('-> ShopsByTypeUtils.jsx - fetchShopsByType() - Error = ', err);
      setShops([]);
