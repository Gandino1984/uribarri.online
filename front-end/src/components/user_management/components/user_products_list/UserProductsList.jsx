...
import UserProductManagementUtils from './UserProductManagementUtils.jsx';
...
const UserProductsList = () => {
  ...
  const { filterProducts, fetchProductsByShop, fetchProductTypes } = UserProductManagementUtils();
